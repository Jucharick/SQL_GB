...
-- 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/test_db.csv' 
-- 'C:/Users/Юлия Чарикова/Desktop/GeekBrains/Базы данных и SQL/Scripts/test_db.csv'
...
SELECT
  ...
  station,
  station_time,
  SUBTIME(LEAD(station_time) OVER(PARTITION BY train_id ORDER BY train_id), station_time) AS time_to_next_station --  внутри окна нужна сортировка, иначе будем получать случайные значения
FROM trains;
